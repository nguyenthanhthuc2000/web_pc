                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        <label>Đã bán</label>
                                                        <div class="time-icon">
                                                            <input type="number" class="form-control" name="sold" value="0" onkeypress="return isNumberKey(event)">
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        <label>Tồn kho</label>
                                                        <div class="time-icon">
                                                            <input type="number" class="form-control" name="remains" value="0" onkeypress="return isNumberKey(event)">
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="col-md-12">
